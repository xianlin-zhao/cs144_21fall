...
class NetworkInterface {
  private:
    ...
    std::map<uint32_t, EthernetAddress> ip2Ether{};
    std::map<uint32_t, size_t> ip2duraTime{};
    std::list<std::pair<uint32_t, EthernetFrame>> waitList{};
    std::map<uint32_t, size_t> arpTime{};
